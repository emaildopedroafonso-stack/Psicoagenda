...
const Login = () => {
  ...
  const handleLoginSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrorMsg(translateFirebaseError(error.message));
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const handleGoogleLogin = async () => {
    try {
        ...
        // O redirecionamento pode acontecer automaticamente pelo Observer no AppContext,
  ...
  const handleVerifyAndCreate = async (e: React.FormEvent) => {
    ...
    // Nota: O registro real no Firebase via AppContext pode precisar da senha.
    // Neste fluxo simplificado, o AppContext está criando com senha padrão ou mock.
    ...
    if (success) {
        ...
        setErrorMsg("Código inválido ou erro ao criar conta.");
    }
  };
                ...
                <div className="animate-fade-in">
                    <form onSubmit={handleLoginSubmit} className="space-y-4">
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full bg-teal-600 hover:bg-teal-700 text-white font-bold py-3 rounded-lg transition-colors shadow-md mt-4 flex justify-center"
                        >
            ...
            {authMode === 'REGISTER' && registerStep === 'VERIFICATION' && (
                <div className="animate-fade-in text-center">
                    ...
                    <p className="text-sm text-slate-500 mb-6">
                        Simulação: Digite <strong>123456</strong> para validar o e-mail: <br/><strong>{newContact}</strong>
                    </p>
